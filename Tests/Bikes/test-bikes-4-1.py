...
def test_mariadb_query():
    ...
    try:
        ...
        cursor = conn.cursor()
        query = "SELECT * FROM TripUsers WHERE tripduration > (SELECT AVG(tripduration) FROM TripUsers);"  
...
def test_mongodb_query():
    ...
    try:
        ...
        pipeline = [
            {'$match': {'tripduration': {'$gt': avg_duration}}},
            {'$project': {'_id': 0, 'trip_id': 1, 'tripduration': 1, 'starttime': 1}}
        ]
