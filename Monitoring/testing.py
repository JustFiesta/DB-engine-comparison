...
def main():
    ...
    mongo_query = {"pole": "wartość"}  # Dostosuj zapytanie do swojej bazy danych MongoDB
    mongo_czas, mongo_metryki = wykonaj_zapytanie_mongo("kolekcja", mongo_query)

    # Przykładowe zapytanie do MariaDB
    mariadb_query = "SELECT * FROM twoja_tabela WHERE warunek;"  # Dostosuj zapytanie do swojej bazy danych MariaDB
